...
admin_router.post("/doctor", auth_middleware, role_check, validate(schemas.doctorSchema), admin_contoller.add_doctor);
...
admin_router.patch("/appointments", auth_middleware, role_check, validate(schemas.appointmentUpdateSchema), admin_contoller.update_appointment);
admin_router.post("/payment", auth_middleware, role_check, validate(schemas.appointmentUpdateSchema), admin_contoller.update_appointment);
